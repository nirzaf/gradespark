import{j as e}from"./vendor-three-BYOb-Ddr.js";import{r as u}from"./vendor-router-D-_vtQhX.js";import{u as d}from"./useScrollToTop-DEZ19Wq-.js";import"./vendor-react-DJG_os-6.js";function h({items:t}){const a=(o,i)=>{i.preventDefault();const r=document.getElementById(o);r&&(r.scrollIntoView({behavior:"smooth"}),window.history.pushState(null,"",`#${o}`))};return e.jsxs("section",{className:"mb-8",children:[e.jsx("h2",{className:"text-2xl font-semibold mb-4",children:"Table of Contents"}),e.jsx("nav",{className:"space-y-2",children:t.map(({id:o,title:i})=>e.jsx("a",{href:`#${o}`,onClick:r=>a(o,r),className:"block text-blue-600 hover:underline cursor-pointer",children:i},o))})]})}function y({id:t,title:a,content:o}){const i=r=>r.split(`

`).map((s,n)=>{if(s.includes(":")){const[c,...l]=s.split(":");return e.jsxs("div",{className:"mb-4",children:[e.jsx("h3",{className:"text-xl font-semibold mb-2",children:c.trim()}),e.jsx("p",{className:"text-gray-700",children:l.join(":").trim()})]},n)}return e.jsx("p",{className:"text-gray-700 mb-4",children:s.trim()},n)});return e.jsxs("section",{id:t,className:"mb-8",children:[e.jsx("h2",{className:"text-2xl font-semibold mb-4",children:a}),i(o)]})}function p(){return e.jsxs("section",{id:"introduction",className:"mb-8",children:[e.jsx("h2",{className:"text-2xl font-semibold mb-4",children:"1. INTRODUCTION"}),e.jsx("p",{className:"text-gray-700 mb-4",children:"At Grade Spark Academy, we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our services."}),e.jsxs("p",{className:"text-gray-700 mb-4",children:["This Privacy Policy applies to all information collected through our website ",e.jsx("a",{href:"https://gradespark.com",className:"text-blue-600 hover:underline",children:"gradespark.com"}),", related services, and any other means through which you may interact with Grade Spark Academy."]}),e.jsx("p",{className:"text-gray-700 mb-4",children:"We are committed to complying with the General Data Protection Regulation (GDPR) and other applicable data protection laws. As a data controller, we determine the purposes and means of processing personal data collected through our services."}),e.jsx("p",{className:"text-gray-700 mb-4",children:"Please read this Privacy Policy carefully to understand our policies and practices regarding your information. If you do not agree with our policies and practices, please do not use our services. By accessing or using our services, you agree to this Privacy Policy."})]})}function m(){return e.jsxs("section",{id:"contact",className:"mb-8",children:[e.jsx("h2",{className:"text-2xl font-semibold mb-4",children:"14. CONTACT US"}),e.jsx("p",{className:"text-gray-700 mb-2",children:"If you have any questions about this Privacy Policy, your personal data, or if you would like to exercise any of your data protection rights, please contact us:"}),e.jsxs("div",{className:"text-gray-700",children:[e.jsx("p",{children:"Email: privacy@gradespark.com"}),e.jsxs("p",{children:["Website: ",e.jsx("a",{href:"https://gradespark.com/contact",className:"text-blue-600 hover:underline",children:"gradespark.com/contact"})]}),e.jsx("p",{children:"Data Protection Officer: dpo@gradespark.com"}),e.jsx("p",{className:"mt-4",children:"We will respond to all legitimate requests within 30 days."})]})]})}const f=[{id:"introduction",title:"1. INTRODUCTION"},{id:"information-we-collect",title:"2. INFORMATION WE COLLECT"},{id:"how-we-use-information",title:"3. HOW WE USE YOUR INFORMATION"},{id:"legal-basis",title:"4. LEGAL BASIS FOR PROCESSING PERSONAL DATA UNDER GDPR"},{id:"retention",title:"5. RETENTION OF YOUR PERSONAL DATA"},{id:"transfer",title:"6. TRANSFER OF YOUR PERSONAL DATA"},{id:"disclosure",title:"7. DISCLOSURE OF YOUR PERSONAL DATA"},{id:"your-rights",title:"8. YOUR DATA PROTECTION RIGHTS UNDER GDPR"},{id:"cookies",title:"9. COOKIES AND TRACKING TECHNOLOGIES"},{id:"analytics",title:"10. ANALYTICS"},{id:"children-privacy",title:"11. CHILDREN'S PRIVACY"},{id:"links",title:"12. LINKS TO OTHER WEBSITES"},{id:"changes",title:"13. CHANGES TO THIS PRIVACY POLICY"},{id:"contact",title:"14. CONTACT US"}],g=[{id:"information-we-collect",title:"2. INFORMATION WE COLLECT",content:`We collect several different types of information for various purposes to provide and improve our Service to you:
...
• Marketing cookies (only with your explicit consent)`},{id:"how-we-use-information",title:"3. HOW WE USE YOUR INFORMATION",content:`We use the collected data for various purposes:
...
• To protect the rights, property, or safety of Grade Spark Academy, our users, or others`},{id:"legal-basis",title:"4. LEGAL BASIS FOR PROCESSING PERSONAL DATA UNDER GDPR",content:`Under the General Data Protection Regulation (GDPR), we process your personal data based on the following legal grounds:
...
• You can request a copy of your data before account closure`},{id:"transfer",title:"6. TRANSFER OF YOUR PERSONAL DATA",content:`Your information, including personal data, may be transferred to and maintained on computers located outside of your state, province, country, or other governmental jurisdiction where data protection laws may differ from those in your jurisdiction.
...
• You can contact us for more information about specific transfers of your data`},{id:"disclosure",title:"7. DISCLOSURE OF YOUR PERSONAL DATA",content:`We may disclose your personal data in the following situations:
...
• We will inform you about the purpose and obtain your consent before such disclosure`},{id:"your-rights",title:"8. YOUR DATA PROTECTION RIGHTS UNDER GDPR",content:`Under the General Data Protection Regulation (GDPR), you have certain data protection rights. Grade Spark Academy aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your personal data.
...
• For more information, please contact your local data protection authority`},{id:"cookies",title:"9. COOKIES AND TRACKING TECHNOLOGIES",content:`We use cookies and similar tracking technologies to track activity on our Service and hold certain information.
...
• These third parties have their own privacy policies which we encourage you to review`},{id:"analytics",title:"10. ANALYTICS",content:`We may use third-party Service Providers to monitor and analyze the use of our Service.
...
• To provide a better user experience`},{id:"children-privacy",title:"11. CHILDREN'S PRIVACY",content:`Our Service is not directed to anyone under the age of 18 ("Children").
...
• We will take appropriate measures to ensure this data is not used or shared`},{id:"links",title:"12. LINKS TO OTHER WEBSITES",content:`Our Service may contain links to other websites that are not operated by us.
...
• Their use of this information is governed by their respective privacy policies`},{id:"changes",title:"13. CHANGES TO THIS PRIVACY POLICY",content:`We may update our Privacy Policy from time to time.
...
• You can contact us to obtain a copy of earlier versions`}],R=()=>(d(),u.useEffect(()=>{document.title="Privacy Policy - Grade Spark Academy";const t=()=>{const a=window.location.href,o=a.lastIndexOf("#");if(o!==-1){const i=a.substring(o+1),r=document.getElementById(i);r&&setTimeout(()=>{r.scrollIntoView({behavior:"smooth"})},100)}};return window.addEventListener("hashchange",t),t(),()=>window.removeEventListener("hashchange",t)},[]),e.jsxs("div",{className:"container mx-auto px-4 py-12",children:[e.jsx("h1",{className:"text-4xl font-bold mb-8 text-center",children:"Privacy Policy"}),e.jsx("p",{className:"text-gray-600 text-center mb-12",children:"Last updated: June 1, 2023"}),e.jsxs("div",{className:"max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md",children:[e.jsx(p,{}),e.jsx(h,{items:f}),g.map(t=>e.jsx(y,{id:t.id,title:t.title,content:t.content},t.id)),e.jsx(m,{})]})]}));export{R as default};
