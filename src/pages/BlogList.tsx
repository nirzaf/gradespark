...
import { getAllBlogPosts, formatBlogDate } from '../utils/blogUtils';
...
const BlogList = () => {
    ...
    useEffect(() => {
        // Function to fetch blog posts from Markdown files
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {currentBlogs.map((blog) => (
                                <div key={blog.slug} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
