  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
      <div className="text-center">
        <Users className="w-12 h-12 text-celeste mx-auto mb-4" />
      ...
      <div className="text-center">
        <Target className="w-12 h-12 text-celeste mx-auto mb-4" />
      ...
      <div className="text-center">
        <Globe2 className="w-12 h-12 text-celeste mx-auto mb-4" />
